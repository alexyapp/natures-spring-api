            ...
            <div class="card mb-3">
                ...
                <div class="card-body p-3">
                    <form id="event-form">
                        ...
                        <div id="cover-image-wrapper" class="d-none">
                            <img style="width: 100%" id="cover-image" src="" alt="Cover Image">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input style="text-transform: capitalize;" id="name" class="form-control" type="text" name="name" required>
                        ...
                        <div class="form-group">
                            ...
                            <input id="start_date" class="form-control" type="text" name="start_date" required>
                            <div class="invalid-feedback"></div>
                        </div>
            ...
            $('#event-form').submit(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (res.data) {
                            window.location = '/admin/events?success=true&action=create';
                        }
                    },
                    error: function(err) {
                        submitButton.attr('disabled', false).text('Submit');
